...
-- All of this is copied from https://github.com/hendrikmi/neovim-kickstart-config/blob/main/lua/core/options.lua
...
-- All of this is copied from https://github.com/hendrikmi/neovim-kickstart-config/blob/main/lua/core/keymaps.lua
--
